Perfecto—vamos a llevar esto a **nivel cine + viralidad + solidez técnica**.

Voy a hacer tres cosas en una sola pasada:

1. 🔧 **Ajustar el índice** (para introducir el conflicto científico como motor de debate)
2. 🧠 **Integrar un “eje científico” dentro de la narrativa** (sin volverlo técnico pesado)
3. ✍️ **Reescribir Capítulo 2** para que genere conversación real (tipo Black Mirror / Nolan)
